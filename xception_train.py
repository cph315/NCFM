...
Xception_notop = Xception.Xception(include_top=False, weights='imagenet',input_shape=(299,299,3))
...
output = Xception_notop.output  # Shape: (8, 8, 2048)
...
# autosave best Model
best_model_file = "./Xception_weights.h5"
